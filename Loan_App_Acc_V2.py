...
def upload_to_s3(s3):
    ...
    local_file_path = f'/home/anuj/Documents/ANUJ_Project/ml-project-1/{csv_file_key}'
    # Create an S3 client
...
#         global csv_file_key
#         st.write(file_ext_chk(s3))
#         if file_ext_chk(s3) == True:
#             return None
       
#         else : 
#             with open(csv_file_key,'a') as log_file:
#                  st.write('I am creating file locally and uploading it to the s3 bucket for frst time')
...
def Logging_Db(lg_ls,obj):
    ...
    st.write(f'i am writing content {csv_content}')
